  ...
  return (
    ...
    >
      ...
      <motion.p className='text-center max-w-xl mx-auto mt-5'
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }} // ✅ fixed typo
      ...
      <motion.button onClick={onClickHandler}
        className='sm:text-lg text-white bg-black w-auto mt-8 mx-12 py-2.5 px-5 flex items-center gap-2 rounded-full'
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        initial={{ opacity: 0 }} // ✅ fixed typo
        animate={{ opacity: 1 }}
      ...
      <motion.p
        ...
        Generated Images from <span className='bg-blue'>Imagify</span>
      </motion.p>
    </motion.div>
  )
}
